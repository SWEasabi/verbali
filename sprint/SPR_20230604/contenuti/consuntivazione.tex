...
\begin{table}[H]
    \begin{xltabular}{\textwidth}{X l l}
        ...
        \endhead
        \hline
        stesura specifica delle basi di dati & parziale & Progettista \\
        stesura specifica architetturale & parziale & Progettista \\
        stesura sistema di autenticazione & parziale &Progettista \\
